...
import com.morixa.adminagro.repository.ProvinciaRepository;
import com.morixa.adminagro.service.ProvinciaService;
...
/**
 * REST controller for managing {@link com.morixa.adminagro.domain.Provincia}.
 */
@RestController
@RequestMapping("/api")
public class ProvinciaResource {
    ...
    public ResponseEntity<ProvinciaDTO> updateProvincia(
        ...
        ProvinciaDTO result = provinciaService.update(provinciaDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<ProvinciaDTO>> getAllProvincias(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
