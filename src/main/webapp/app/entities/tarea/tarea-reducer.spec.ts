...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tarea.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAREA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAREA actions', async () => {
      const expectedActions = [
        {
