...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trabajo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRABAJO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRABAJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRABAJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRABAJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRABAJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRABAJO actions', async () => {
      const expectedActions = [
        {
