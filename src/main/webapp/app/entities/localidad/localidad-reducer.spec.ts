...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './localidad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCALIDAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCALIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCALIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCALIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCALIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCALIDAD actions', async () => {
      const expectedActions = [
        {
