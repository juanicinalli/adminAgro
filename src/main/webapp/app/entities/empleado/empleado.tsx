  ...
  return (
    <div>
      <h2 id="empleado-heading" data-cy="EmpleadoHeading">
        <Translate contentKey="adminAgroApp.empleado.home.title">Empleados</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adminAgroApp.empleado.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/empleado/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adminAgroApp.empleado.home.createLabel">Create new Empleado</Translate>
          </Link>
        </div>
      </h2>
        ...
        {empleadoList && empleadoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="adminAgroApp.empleado.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nombre')}>
                  <Translate contentKey="adminAgroApp.empleado.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('apellido')}>
                  <Translate contentKey="adminAgroApp.empleado.apellido">Apellido</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="adminAgroApp.empleado.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('numeroDeTelefono')}>
                ...
                <th className="hand" onClick={sort('salario')}>
                  <Translate contentKey="adminAgroApp.empleado.salario">Salario</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="adminAgroApp.empleado.trabajo">Trabajo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {empleadoList.map((empleado, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{empleado.trabajo ? <Link to={`/trabajo/${empleado.trabajo.id}`}>{empleado.trabajo.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adminAgroApp.empleado.home.notFound">No Empleados found</Translate>
            </div>
          )
        )}
      </div>
