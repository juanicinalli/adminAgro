...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './campo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMPO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAMPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAMPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAMPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAMPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAMPO actions', async () => {
      const expectedActions = [
        {
