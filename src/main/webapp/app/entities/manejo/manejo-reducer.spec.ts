...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './manejo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANEJO_LIST actions', async () => {
    ...
    it('dispatches FETCH_MANEJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MANEJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MANEJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MANEJO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MANEJO actions', async () => {
      const expectedActions = [
        {
