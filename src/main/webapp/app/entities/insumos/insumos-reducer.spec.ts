...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './insumos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSUMOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INSUMOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSUMOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSUMOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSUMOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSUMOS actions', async () => {
      const expectedActions = [
        {
