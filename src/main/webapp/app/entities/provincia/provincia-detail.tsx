...
export const ProvinciaDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="provinciaDetailsHeading">
          <Translate contentKey="adminAgroApp.provincia.detail.title">Provincia</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nombre">
              <Translate contentKey="adminAgroApp.provincia.nombre">Nombre</Translate>
            </span>
          </dt>
          <dd>{provinciaEntity.nombre}</dd>
          <dt>
            <Translate contentKey="adminAgroApp.provincia.pais">Pais</Translate>
          </dt>
          <dd>{provinciaEntity.pais ? provinciaEntity.pais.id : ''}</dd>
        </dl>
