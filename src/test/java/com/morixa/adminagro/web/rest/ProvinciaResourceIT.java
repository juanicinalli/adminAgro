...
import com.morixa.adminagro.service.mapper.ProvinciaMapper;
...
class ProvinciaResourceIT {
    ...
    public static Provincia createEntity(EntityManager em) {
        Provincia provincia = new Provincia().nombre(DEFAULT_NOMBRE);
        return provincia;
    }
    ...
    public static Provincia createUpdatedEntity(EntityManager em) {
        Provincia provincia = new Provincia().nombre(UPDATED_NOMBRE);
        return provincia;
    }
    ...
    void putNewProvincia() throws Exception {
        ...
        updatedProvincia.nombre(UPDATED_NOMBRE);
    ...
    void fullUpdateProvinciaWithPatch() throws Exception {
        ...
        partialUpdatedProvincia.nombre(UPDATED_NOMBRE);
